...
class ApiService {
  ...
  static Future<Map<String, dynamic>> getTente(int tenteId, {String? groupeId}) async {
  ...
  static Future<void> deleteTente(int tenteId, {required String groupeId}) async {
    final url = '$baseUrl/tentes/$tenteId?groupeId=$groupeId';
  ...
  static Future<Map<String, dynamic>> getEvenement(int evenementId, {String? groupeId}) async {
    final url = groupeId != null && groupeId.isNotEmpty
  ...
  static Future<void> deleteEvenement(int evenementId, {required String groupeId}) async {
    final url = '$baseUrl/evenements/$evenementId?groupeId=$groupeId';
    final response = await http.delete(Uri.parse(url));
    if (response.statusCode != 204) {
